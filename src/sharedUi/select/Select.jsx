...
function Select({name,options,Styles,value,setValue,setAscending,ascending}){
    const [expand,setExpand] = useState(false);
    return(
       <div role="combobox" aria-haspopup="listbox" aria-expanded="false" aria-controls="OptionList" className="w-15rem relative no-user-select z-index-1">
