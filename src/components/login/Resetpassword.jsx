    ...
    return(
        <>
            ...
            <form onReset={handleFormreset} ref={resetPasswordForm} noValidate>
                ...
                <input disabled={!enableOtp} onChange={(e)=>handleOtpInput(e)} className='ltr-spacing-2' type="text" maxLength="6" id='otp' name='otp' placeholder='Enter OTP that you received in your mail' autoComplete='off'/>
